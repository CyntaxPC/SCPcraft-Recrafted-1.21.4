package net.cyntax.scprecrafted.sound;
...
public class ModSounds {
    ...
    public static final RegistryKey<JukeboxSong> GENDER_SWITCHER_SONG_KEY =
            RegistryKey.of(RegistryKeys.JUKEBOX_SONG, Identifier.of(SCPcraftRecrafted.MOD_ID, "gender_switcher_song"));
    ...
    public static final RegistryKey<JukeboxSong> BURNING_MAN_SONG_KEY =
            RegistryKey.of(RegistryKeys.JUKEBOX_SONG, Identifier.of(SCPcraftRecrafted.MOD_ID, "burning_man_song"));
    ...
    public static final RegistryKey<JukeboxSong> EYEPODS_SONG_KEY =
            RegistryKey.of(RegistryKeys.JUKEBOX_SONG, Identifier.of(SCPcraftRecrafted.MOD_ID, "eyepods_song"));
    ...
    public static final RegistryKey<JukeboxSong> RED_ICE_SONG_KEY =
            RegistryKey.of(RegistryKeys.JUKEBOX_SONG, Identifier.of(SCPcraftRecrafted.MOD_ID, "red_ice_song"));
    ...
    public static final RegistryKey<JukeboxSong> SWAMP_WOMAN_SONG_KEY =
            RegistryKey.of(RegistryKeys.JUKEBOX_SONG, Identifier.of(SCPcraftRecrafted.MOD_ID, "swamp_woman_song"));
    ...
    public static final RegistryKey<JukeboxSong> UNSEEN_MOLD_SONG_KEY =
            RegistryKey.of(RegistryKeys.JUKEBOX_SONG, Identifier.of(SCPcraftRecrafted.MOD_ID, "unseen_mold_song"));
    ...
    public static final RegistryKey<JukeboxSong> DARK_FORM_SONG_KEY =
            RegistryKey.of(RegistryKeys.JUKEBOX_SONG, Identifier.of(SCPcraftRecrafted.MOD_ID, "dark_form_song"));
    ...
    public static final RegistryKey<JukeboxSong> TELEKILL_ALLOY_SONG_KEY =
            RegistryKey.of(RegistryKeys.JUKEBOX_SONG, Identifier.of(SCPcraftRecrafted.MOD_ID, "telekill_alloy_song"));
    ...
    public static final RegistryKey<JukeboxSong> SKELETON_KEY_SONG_KEY =
            RegistryKey.of(RegistryKeys.JUKEBOX_SONG, Identifier.of(SCPcraftRecrafted.MOD_ID, "skeleton_key_song"));
    ...
    public static final RegistryKey<JukeboxSong> SUPER_BALL_SONG_KEY =
            RegistryKey.of(RegistryKeys.JUKEBOX_SONG, Identifier.of(SCPcraftRecrafted.MOD_ID, "super_ball_song"));
    ...
    public static final RegistryKey<JukeboxSong> FOUNTAIN_OF_YOUTH_SONG_KEY =
            RegistryKey.of(RegistryKeys.JUKEBOX_SONG, Identifier.of(SCPcraftRecrafted.MOD_ID, "fountain_of_youth_song"));
    ...
    public static final RegistryKey<JukeboxSong> EVERYTHING_TREE_SONG_KEY =
            RegistryKey.of(RegistryKeys.JUKEBOX_SONG, Identifier.of(SCPcraftRecrafted.MOD_ID, "everything_tree_song"));
    ...
    public static final RegistryKey<JukeboxSong> REWIND_MAN_SONG_KEY =
            RegistryKey.of(RegistryKeys.JUKEBOX_SONG, Identifier.of(SCPcraftRecrafted.MOD_ID, "rewind_man_song"));
    ...
    public static final RegistryKey<JukeboxSong> SONG_OF_GENESIS_SONG_KEY =
            RegistryKey.of(RegistryKeys.JUKEBOX_SONG, Identifier.of(SCPcraftRecrafted.MOD_ID, "song_of_genesis_song"));
    ...
    private static SoundEvent registerSoundEvent(String name) {
        Identifier id = Identifier.of(SCPcraftRecrafted.MOD_ID, name);
        return Registry.register(Registries.SOUND_EVENT, id, SoundEvent.of(id));
    }

    public static void registerSounds() {
        SCPcraftRecrafted.LOGGER.info("Registering modded sounds for " +SCPcraftRecrafted.MOD_ID);
    }
}
